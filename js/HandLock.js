!function (t, e) {
    ...
    return function (t) {
        ...
        var r = n(29)("wks"), o = n(20), i = n(2).Symbol, u = "function" == typeof i;
        ...
        var r = n(2), o = n(0), i = n(13), u = n(8), c = function (t, e, n) {
            var a, f, s, l = t & c.F, p = t & c.G, h = t & c.S, d = t & c.P, v = t & c.B, y = t & c.W,
                m = p ? o : o[e] || (o[e] = {}), g = m.prototype, _ = p ? r : h ? r[e] : (r[e] || {}).prototype;
            p && (n = e);
        ...
        var r = n(3), o = n(44), i = n(32), u = Object.defineProperty;
        ...
        var r = n(6).f, o = n(7), i = n(1)("toStringTag");
        t.exports = function (t, e, n) {
        ...
        var r = n(3), o = n(92), i = n(25), u = n(28)("IE_PROTO"), c = function () {
        }, a = function () {
        ...
        var r = n(2), o = n(0), i = n(16), u = n(34), c = n(6).f;
        t.exports = function (t) {
        ...
        var f = n(41), s = r(f), l = n(21), p = r(l), h = n(37), d = r(h), v = n(36), y = r(v), m = n(38), g = r(m),
            _ = n(39), b = r(_), x = {
                container: null,
                focusColor: "#e06555",
                fgColor: "#d6dae5",
                ...
                return (0, b["default"])(t, null, [{
                    key: "ERR_NOT_ENOUGH_POINTS", get: function () {
                        return "not enough points"
                    }
                }, {
                    key: "ERR_USER_CANCELED", get: function () {
                        return "user canceled"
                    }
                }, {
                    key: "ERR_NO_TASK", get: function () {
                        return "no task"
                    }
                }]), (0, b["default"])(t, [{
                    key: "render", value: function () {
                        if (this.circleCanvas) return !1;
                        var t = this.options, e = t.container || document.createElement("div");
                        ...
                        var n = e.getBoundingClientRect(), r = n.width, o = n.height, i = document.createElement("canvas");
                        ...
                        var u = i.cloneNode(!0), c = i.cloneNode(!0);
                        ...
                        }, {passive: !1}), this.clearPath(), !0
                    }
                }, {
                    key: "clearPath", value: function () {
                        this.circleCanvas || this.render();
                        var t = this.circleCanvas, e = this.lineCanvas, n = this.moveCanvas, r = t.getContext("2d"),
                            o = e.getContext("2d"), i = n.getContext("2d"), c = t.width, a = this.options, f = a.n,
                            s = a.fgColor, l = a.innerRadius;
                        r.clearRect(0, 0, c, c), o.clearRect(0, 0, c, c), i.clearRect(0, 0, c, c);
                        for (var p = Math.round(c / (f + 1)), h = [], d = 1; d <= f; d++) for (var v = 1; v <= f; v++) {
                            var y = p * d, m = p * v;
                            u(r, s, m, y, l);
                            var g = {x: m, y: y};
                            g.pos = [d, v], h.push(g)
                        ...
                        var n = (0, d["default"])(s["default"].mark(function r() {
                            return s["default"].wrap(function (e) {
                                for (; ;) switch (e.prev = e.next) {
                                    ...
                                    case 2:
                                        return e.abrupt("return", p["default"].resolve({err: new Error(t.ERR_NO_TASK)}));
                                    case 3:
                                    case"end":
                                        return e.stop()
                                }
                                    ...
                                    case 2:
                                        return e = this.circleCanvas, n = this.lineCanvas, f = this.moveCanvas, l = this.options, h = e.getContext("2d"), d = n.getContext("2d"), v = f.getContext("2d"), e.addEventListener("touchstart", function () {
                                            ...
                                            for (var e = t.changedTouches[0], n = e.clientX, r = e.clientY, s = l.bgColor, p = l.focusColor, m = l.innerRadius, g = l.outerRadius, _ = l.touchRadius, x = o(f, n, r), w = 0; w < b.circles.length; w++) {
                                                var E = b.circles[w], O = E.x, j = E.y;
                                                if (i(E, x) < _) {
                                                    if (u(h, s, O, j, g), u(h, p, O, j, m), c(h, p, O, j, g), y.length) {
                                                        var S = y[y.length - 1], k = S.x, P = S.y;
                                                        a(d, p, O, j, k, P)
                                                    }
                                            ...
                                            if (y.length) {
                                                var T = y[y.length - 1], M = T.x, C = T.y, L = x.x, A = x.y;
                                            ...
                                            var o = function i(r) {
                                                if (v.clearRect(0, 0, f.width, f.height), y.length) {
                                                    ...
                                                    var u = {
                                                        err: o, records: y.map(function (t) {
                                                            return t.pos.join("")
                                                        }).join("")
                                                    };
        ...
        var r = n(12), o = n(1)("toStringTag"), i = "Arguments" == r(function () {
            return arguments
        }()), u = function (t, e) {
            try {
                return t[e]
        ...
        "use strict";
        var r = n(16), o = n(5), i = n(51), u = n(8), c = n(7), a = n(14), f = n(85), s = n(19), l = n(49),
        ...
        t.exports = function (t, e, n, v, y, m, g) {
            ...
            var _, b, x, w = function (t) {
                ...
                }, E = e + " Iterator", O = "values" == y, j = !1, S = t.prototype,
                k = S[p] || S["@@iterator"] || y && S[y], P = k || w(y), R = y ? O ? w("entries") : P : void 0,
                T = "Array" == e ? S.entries || k : k;
            if (T && (x = l(T.call(new t))) !== Object.prototype && (s(x, E, !0), r || c(x, p) || u(x, p, d)), O && k && "values" !== k.name && (j = !0, P = function () {
                    return k.call(this)
                }), r && !g || !h && !j && S[p] || u(S, p, P), a[e] = P, a[E] = d, y) if (_ = {
                    values: O ? P : w("values"),
                    keys: m ? P : w("keys"),
                    entries: R
                }, g) for (b in _) b in S || i(S, b, _[b]); else o(o.P + o.F * (h || j), e, _);
            return _
        }
    }, function (t, e, n) {
        var r = n(17), o = n(18), i = n(9), u = n(32), c = n(7), a = n(44), f = Object.getOwnPropertyDescriptor;
        ...
        var r = n(50), o = n(25).concat("length", "prototype");
        e.f = Object.getOwnPropertyNames || function (t) {
            return r(t, o)
        }
    }, function (t, e, n) {
        var r = n(7), o = n(31), i = n(28)("IE_PROTO"), u = Object.prototype;
        t.exports = Object.getPrototypeOf || function (t) {
            return t = o(t), r(t, i) ? t[i] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? u : null
        }
    }, function (t, e, n) {
        var r = n(7), o = n(9), i = n(78)(!1), u = n(28)("IE_PROTO");
        t.exports = function (t, e) {
            var n, c = o(t), a = 0, f = [];
        ...
        var r, o, i, u = n(13), c = n(81), a = n(43), f = n(24), s = n(2), l = s.process, p = s.setImmediate,
            h = s.clearImmediate, d = s.MessageChannel, v = 0, y = {}, m = function () {
                var t = +this;
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var o = n(41), i = r(o), u = n(21), c = r(u), a = n(37), f = r(a), s = n(62), l = r(s), p = n(36), h = r(p),
            d = n(38), v = r(d), y = n(67), m = r(y), g = n(39), _ = r(g), b = n(66), x = r(b), w = n(35), E = r(w),
            O = {
                update: {
                ...
                return (0, x["default"])(e, t), (0, _["default"])(e, null, [{
                    ...
                    key: "MODE_UPDATE", get: function () {
                        return "update"
                    }
                }, {
                    key: "MODE_CHECK", get: function () {
                        return "check"
                    }
                }]), (0, _["default"])(e, [{
        ...
        Object.defineProperty(e, "__esModule", {value: !0}), e.Locker = e.Recorder = void 0;
        var o = n(35), i = r(o), u = n(58), c = r(u);
        ...
        e.__esModule = !0;
        var o = n(63), i = r(o), u = n(60), c = r(u), a = n(40), f = r(a);
        ...
        var r = n(13), o = n(84), i = n(82), u = n(3), c = n(53), a = n(101), f = {}, s = {},
            e = t.exports = function (t, e, n, l, p) {
                var h, d, v, y, m = p ? function () {
                    return t
                } : a(t), g = r(n, l, e ? 2 : 1), _ = 0;
                if ("function" != typeof m) throw TypeError(t + " is not iterable!");
                if (i(m)) {
                    for (h = c(t.length); h > _; _++) if ((y = e ? g(u(d = t[_])[0], d[1]) : g(t[_])) === f || y === s) return y
                } else for (v = m.call(t); !(d = v.next()).done;) if ((y = o(v, g, d.value, e)) === f || y === s) return y
            };
        ...
        var r = n(14), o = n(1)("iterator"), i = Array.prototype;
        t.exports = function (t) {
        ...
        var r = n(20)("meta"), o = n(11), i = n(7), u = n(6).f, c = 0, a = Object.isExtensible || function () {
            return !0
        }, f = !n(10)(function () {
        ...
        var r = n(2), o = n(52).set, i = r.MutationObserver || r.WebKitMutationObserver, u = r.process, c = r.Promise,
            a = "process" == n(12)(u);
        t.exports = function () {
        ...
        "use strict";
        var r = n(15), o = n(27), i = n(17), u = n(31), c = n(45), a = Object.assign;
        t.exports = !a || n(10)(function () {
            ...
            for (var n = u(t), a = arguments.length, f = 1, s = o.f, l = i.f; a > f;) for (var p, h = c(arguments[f++]), d = s ? r(h).concat(s(h)) : r(h), v = d.length, y = 0; v > y;) l.call(h, p = d[y++]) && (n[p] = h[p]);
            return n
        } : a
    }, function (t, e, n) {
        ...
        var r = n(11), o = n(3), i = function (t, e) {
        ...
        "use strict";
        var r = n(2), o = n(0), i = n(6), u = n(4), c = n(1)("species");
        t.exports = function (t) {
        ...
        var r = n(42), o = n(1)("iterator"), i = n(14);
        t.exports = n(0).getIteratorMethod = function (t) {
            if (void 0 != t) return t[o] || t["@@iterator"] || i[r(t)]
        }
    }, function (t, e, n) {
        "use strict";
        var r = n(76), o = n(87), i = n(14), u = n(9);
        ...
        "use strict";
        var r, o, i, u = n(16), c = n(2), a = n(13), f = n(42), s = n(5), l = n(11), p = n(22), h = n(77), d = n(80),
            v = n(98), y = n(52).set, m = n(90)(), g = c.TypeError, _ = c.process, b = c.Promise, _ = c.process,
            x = "process" == f(_), w = function () {
            }, E = !!function () {
                try {
                ...
                if (!t._n) {
                    ...
                    m(function () {
                        for (var r = t._v, o = 1 == t._s, i = 0; n.length > i;) !function (e) {
                            var n, i, u = o ? e.ok : e.fail, c = e.resolve, a = e.reject, f = e.domain;
                            try {
                ...
                y.call(c, function () {
                    var e;
                    x ? _.emit("rejectionHandled", t) : (e = c.onrejectionhandled) && e({promise: t, reason: t._v})
                })
            }, L = function (t) {
                var e = this;
        ...
        E || (b = function (t) {
        ...
        }), s(s.G + s.W + s.F * !E, {Promise: b}), n(19)(b, "Promise"), n(97)("Promise"), i = n(0).Promise, s(s.S + s.F * !E, "Promise", {
            reject: function (t) {
                var e = S(this);
            ...
            all: function (t) {
                var e = this, n = S(e), r = n.resolve, o = n.reject, i = P(function () {
                    var n = [], i = 0, u = 1;
                    d(t, !1, function (t) {
                        var c = i++, a = !1;
                ...
                var e = this, n = S(e), r = n.reject, o = P(function () {
                    d(t, !1, function (t) {
        ...
        "use strict";
        var r = n(2), o = n(7), i = n(4), u = n(5), c = n(51), a = n(89).KEY, f = n(10), s = n(29), l = n(19),
            p = n(20), h = n(1), d = n(34), v = n(33), y = n(88), m = n(79), g = n(83), _ = n(3), b = n(9), x = n(32),
            w = n(18), E = n(26), O = n(93), j = n(47), S = n(6), k = n(15), P = j.f, R = S.f, T = O.f, M = r.Symbol,
            C = r.JSON, L = C && C.stringify, A = h("_hidden"), N = h("toPrimitive"), F = {}.propertyIsEnumerable,
            D = s("symbol-registry"), I = s("symbols"), G = s("op-symbols"), U = Object.prototype,
            H = "function" == typeof M, W = r.QObject, K = !W || !W.prototype || !W.prototype.findChild,
            B = i && f(function () {
                return 7 != E(R({}, "a", {
                    get: function () {
                        return R(this, "a", {
                ...
                return t === U && q(G, e, n), _(t), e = x(e, !0), _(n), o(I, e) ? (n.enumerable ? (o(t, A) && t[A][e] && (t[A][e] = !1), n = E(n, {enumerable: w(0, !1)})) : (o(t, A) || R(t, A, w(1, {})), t[A][e] = !0), B(t, e, n)) : R(t, e, n)
            }, z = function (t, e) {
                _(t);
        ...
        (function (e) {
            ...
            if (r.regeneratorRuntime = void 0, t.exports = n(114), o) r.regeneratorRuntime = i; else try {
        ...
        (function (e, n) {
            !function (e) {
                ...
                function r(t, e, n, r) {
                    var o = e && e.prototype instanceof i ? e : i, u = Object.create(o.prototype), c = new d(r || []);
                    ...
                    if (t) {
                        ...
                        if (!isNaN(t.length)) {
                            var n = -1, r = function o() {
                                for (; ++n < t.length;) if (_.call(t, n)) return o.value = t[n], o.done = !1, o;
                ...
                var m, g = Object.prototype, _ = g.hasOwnProperty, b = "function" == typeof Symbol ? Symbol : {},
                    x = b.iterator || "@@iterator", w = b.toStringTag || "@@toStringTag", E = "object" == typeof t,
                    O = e.regeneratorRuntime;
                if (O) return void(E && (t.exports = O));
                O = e.regeneratorRuntime = E ? t.exports : {}, O.wrap = r;
                var j = "suspendedStart", S = "suspendedYield", k = "executing", P = "completed", R = {}, T = {};
                T[x] = function () {
                    return this
                };
                var M = Object.getPrototypeOf, C = M && M(M(v([])));
                    ...
                    constructor: d, reset: function (t) {
                        ...
                        for (var n = this, r = this.tryEntries.length - 1; r >= 0; --r) {
                            ...
                            if (o.tryLoc <= this.prev) {
                                var u = _.call(o, "catchLoc"), c = _.call(o, "finallyLoc");
                                if (u && c) {
